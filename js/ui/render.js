...
const TUTORIAL_GUIDE_MAP = {
  ...
  t27: { tab: 'power', selector: '#power-cooling-mode-select', area: 'Power', focusLabel: 'Cooling-Modus', cta: 'Stelle den Cooling-Modus mindestens einmal um. So lernst du Hitze gegen Leistung abzuwiegen.' },
  t28: { tab: 'power', selector: '#power-cooling-auto-select', area: 'Power', focusLabel: 'Cooling-Auto', cta: 'Teste das Cooling-Auto-Profil. Es nimmt dir spaeter Heat-Management ab.' },
  ...
  t32: { tab: 'power', selector: '#power-layout-select', area: 'Power', focusLabel: 'Rig-Layout', cta: 'Wechsle dein Layout mindestens einmal. Layouts veraendern Platzbedarf, Heat und Effizienz.' },
